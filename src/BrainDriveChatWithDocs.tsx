...
/**
 * Unified BrainDriveChatWithDocs component that combines AI chat, model selection, and conversation history
 */
class BrainDriveChatWithDocs extends React.Component<BrainDriveChatProps, BrainDriveChatState> {
...
(BrainDriveChatWithDocs as any).version = '1.0.1';
